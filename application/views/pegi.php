    ...
    <body>
            ...
            <div class="container">
                ...
                <div id="responsive-nav">
                    ...
                    <ul class="main-nav nav navbar-nav">
                        ...
                        <li class="active"><a href="<?php echo base_url() ?>index.php/admin/pegi">Pegi</a></li>
                    </ul>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($pegi as $element) {
                                echo '<tr>';
                                $i = 0;
                                foreach ($pegi[0]->getObjectVars() as $value) {
                                    if($i == 0){
        ...
        <script type="text/javascript">
            ...
            function createEntry(){
                ...
                $.ajax({
                    method: "post",
                    url: "<?php echo base_url()."index.php/admin/pegi/create/"?>",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            function deleteEntry(value){
                $.ajax({
                    method: "post",
                    url: "<?php echo base_url()."index.php/admin/pegi/delete/"?>",
                    data: {id : value},
                    success: function(data){
                        try {
                            console.log(data);
