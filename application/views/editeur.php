    ...
    <body>
            ...
            <div class="container">
                ...
                <div id="responsive-nav">
                    ...
                    <ul class="main-nav nav navbar-nav">
                        ...
                        <li class="active"><a href="<?php echo base_url() ?>index.php/admin/editeur">Editeur</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <?php foreach ($editeur[0]->getObjectVars() as $key => $value) {
                        ...
                        <tbody>
                            <?php foreach ($editeur as $element) {
                                echo '<tr>';
                                $i = 0;
                                foreach ($editeur[0]->getObjectVars() as $value) {
                                    if($i == 0){
        ...
        <script type="text/javascript">
            ...
            function createEntry(){
                ...
                $.ajax({
                    method: "post",
                    url: "<?php echo base_url()."index.php/admin/editeur/create/"?>",
                    data: formData,
                    processData: false,
                    contentType: false,
